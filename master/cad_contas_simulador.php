...
<div class="slim-mainpanel">
	<div class="container">
		<div align="right" class="mg-b-10"><a href="cad_contas" class="btn btn-purple btn-sm"> VOLTAR</a></div>
		<div class="row">
			<div class="col-md-12">
				<div class="card card-info">
					<div class="card-body" align="justify">
					<label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> Demonstrativo de Cobranças</label>
					<hr>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
							<div align="center"><a href="cad_contas" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Voltar </a></div>
						</div>	
						<div class="col-md-6">
