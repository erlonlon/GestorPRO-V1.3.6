...
<div class="slim-mainpanel">
      <div class="container">
	  <div align="right" class="mg-b-10"><a href="cad_usuario" class="btn btn-purple btn-sm"><i class="fa fa-plus mg-r-10" aria-hidden="true"></i>NOVO USUÁRIO</a></div>
            ...
            <table id="datatable1" class="table display responsive nowrap" width="100%">
			  ...
			  ?>
                <tr>
                  ...
                  <td><?php print $dadosclientes->nome;?><?php print $dadosclientes->Id;?></td>
