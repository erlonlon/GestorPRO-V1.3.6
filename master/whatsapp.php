		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-info">
					...
					<div class="row">
						<div class="col-md-12">
							<div align="center"> <button type="submit" class="btn btn-primary" name="cart">Conectar</button></div>
						</div>		
					</div>		
					</form>	
			...
			<div class="col-md-12">
				<div class="card card-info">
					<div class="card-body" align="justify">
						...
						<div class="row">
							<div class="col-md-12">
								<div align="center"> <button type="submit" class="btn btn-danger" name="cart">Desconectar</button></div>
							</div>		
						</div>		
						</form>	
