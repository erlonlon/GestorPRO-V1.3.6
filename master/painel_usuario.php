...
<div class="slim-mainpanel">
	  ...
	  <div class="dash-headline-two">
          ...
          <div class="d-h-t-right">
            <div class="summary-item">
              <h1>R$: <?php print $resultado = ($valoresrecebidoss->totalpago * $clientesxdados->nascimento) / 100; ?></h1>
              <span>Valor a<br>receber</span>
            </div>
            <div class="summary-item">
              <h1><?php echo $clientesxdados->nascimento; ?>%</h1>
              <span>Taxa sobre<br>recebidos</span>
            </div>
          </div>
        </div><!-- dash-headline-two -->
