		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-info">
					...
					<label class="section-title"><i class="fa fa-check-square-o" aria-hidden="true"></i> CADASTRO DE USUÁRIOS</label>
					<hr>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<div class="styled-select">
								<input type="text" class="form-control" name="porcentagem" maxlength="3" required>
								</div>
							</div>
						</div>
