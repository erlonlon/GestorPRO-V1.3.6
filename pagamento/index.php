...
<div class="slim-mainpanel">
	  ...
	  <div class="slim-pageheader">
		...
		<div class="alert alert-success" role="alert">
            ...
            <strong>Sucesso!!!</strong><br/>Pagamento aprovado.
          </div>
	 ...
	 <?php
	  ...
	  <div class="row">
		  ...
		  <div class="col-md-6 mg-b-5">
				  ...
				  <center>
				  <img src="data:image/png;base64,<?php echo $dadosemprestimos1->qrcode; ?>" width="220"><br/>
				  Pagamento mensalidade com vencimento em<br/><?php echo $datapagamento; ?>
